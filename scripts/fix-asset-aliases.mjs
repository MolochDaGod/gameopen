...
const bare = [
  ...
  ["models/enemies/session/blocker_broker.glb", "blocker_broker.glb"],
  ["models/enemies/session/hollow_knight_vengefly.glb", "hollow_knight_vengefly.glb"],
  ["models/enemies/session/mage_demon.glb", "mage_demon.glb"],
