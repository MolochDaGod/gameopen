...
export const FALLBACK_FOREST_CREEPS: ForestCreepCatalog = {
  ...
  units: [
    ...
    // Session pack (R2 models/enemies/session) — voxel + forest camps
    {
      id: "blocker_broker",
      name: "Blocker Broker",
      role: "camp_elite",
      meshKeys: ["models/enemies/session/blocker_broker.glb"],
      heightM: 2.0,
      hp: 160,
      damage: 22,
      speed: 2.2,
      ...
      xp: 90,
      buffOnKill: "purple_might",
      tags: ["voxel", "melee", "elite", "session"],
    },
    {
      id: "hollow_knight_vengefly",
      name: "Vengefly",
      role: "camp_swarm",
      meshKeys: ["models/enemies/session/hollow_knight_vengefly.glb"],
      heightM: 0.95,
      hp: 35,
      damage: 9,
      speed: 3.4,
      ...
      xp: 18,
      buffOnKill: null,
      tags: ["voxel", "flying", "swarm", "session"],
    },
    {
      id: "mage_demon",
      name: "Mage Demon",
      role: "camp_elite",
      meshKeys: ["models/enemies/session/mage_demon.glb"],
      heightM: 2.0,
      hp: 130,
      damage: 20,
      speed: 2.4,
      ...
      xp: 85,
      buffOnKill: "blue_haste",
      tags: ["voxel", "magic", "ranged", "session"],
    },
    {
      id: "lowpoly_rhino",
      name: "Rhino",
      role: "jungle_camp",
      meshKeys: ["models/enemies/session/lowpoly_rhino.glb"],
      heightM: 1.65,
      hp: 140,
      damage: 24,
      speed: 3.0,
      ...
      xp: 75,
      buffOnKill: "red_rage",
      tags: ["voxel", "beast", "session"],
    },
    {
      id: "violet_4_hn_creature",
      name: "Violet HN Creature",
      role: "camp_melee",
      meshKeys: ["models/enemies/session/violet_4_hn_creature.glb"],
      heightM: 1.8,
      hp: 110,
      damage: 16,
      speed: 2.6,
  ...
  camps: {
    ...
    session_voxel_pack: {
      label: "Session voxel mob pack",
      use: ["voxel", "brawl", "sailtest", "forest-map", "genesis"],
      buffOnClear: "red_rage",
      xpBonus: 50,
      spawns: [
        { unitId: "hollow_knight_vengefly", count: 4, radius: 9 },
