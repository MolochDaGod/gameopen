...
export const VFX_PRESETS: VfxPreset[] = [
  ...
  { id: "witchArrow", label: "Bomb Arrow (projectilebomb)", group: "energy" },
  { id: "witchMissile", label: "Bomb Missile (projectilebomb)", group: "energy" },
  { id: "witchDisk", label: "Bomb Disk AoE (projectilebomb)", group: "energy" },
