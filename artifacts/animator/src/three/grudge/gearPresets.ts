...
const BRB: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior", description: "Chainmail & Great Axe", color: "#c2410c", animPack: "polearm",      visibleMeshes: ["BRB_head_B","BRB_body_C","BRB_arms_B","BRB_legs_B","BRB_shoulderpads_B","BRB_weapon_axe_C"] },
...
const DWF: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior", description: "Chainmail & Great Axe", color: "#c2410c", animPack: "polearm",      visibleMeshes: ["DWF_Units_Head_G","DWF_Units_Body_C","DWF_Units_Arms_B","DWF_Units_Legs_B","DWF_Units_Shoulderpads_B","DWF_Weapon_axe_C"] },
...
const ELF: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior", description: "Chainmail & Spear",     color: "#c2410c", animPack: "polearm",      visibleMeshes: ["ELF_Units_Head_D","ELF_Units_Body_C","ELF_Units_Arms_B","ELF_Units_Legs_B","ELF_Units_Shoulderpads_B","ELF_weapon_spear"] },
...
const ORC: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior",  description: "Chainmail & Great Axe",color: "#c2410c", animPack: "polearm",      visibleMeshes: ["ORC_Units_Head_E","ORC_Units_Body_C","ORC_Units_Arms_B","ORC_Units_Legs_B","ORC_Units_Shoulderpads_C","ORC_weapon_Axe_B"] },
...
const UD: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior",      description: "Plague Plate & Axe",    color: "#c2410c", animPack: "polearm",      visibleMeshes: ["UD_Units_head_G","UD_Units_body_D","UD_Units_arms_C","UD_Units_legs_C","UD_Units_shoulderpads_B","UD_weapon_Axe_B"] },
...
const WK: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior", description: "Chainmail & Great Axe",   color: "#c2410c", animPack: "polearm",      visibleMeshes: ["WK_Units_head_D","WK_Units_Body_C","WK_Units_Arms_B","WK_Units_Legs_B","WK_Units_shoulderpads_A","WK_weapon_axe_B"] },
