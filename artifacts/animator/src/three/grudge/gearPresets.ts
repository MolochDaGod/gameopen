...
const BRB: GearPreset[] = [
  ...
  // Warrior = sturdy MMO 1H sword+shield (not polearm stretch kit)
  { id: "warrior", label: "Warrior", description: "Chainmail & Sword",     color: "#c2410c", animPack: "sword_shield", visibleMeshes: ["BRB_head_B","BRB_body_C","BRB_arms_B","BRB_legs_B","BRB_shoulderpads_B","BRB_weapon_sword_B","BRB_Shield_B"] },
...
const DWF: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior", description: "Chainmail & Sword",     color: "#c2410c", animPack: "sword_shield", visibleMeshes: ["DWF_Units_Head_G","DWF_Units_Body_C","DWF_Units_Arms_B","DWF_Units_Legs_B","DWF_Units_Shoulderpads_B","DWF_Weapon_sword_B","DWF_Shield_B"] },
...
const ORC: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior",  description: "Chainmail & Axe",      color: "#c2410c", animPack: "sword_shield", visibleMeshes: ["ORC_Units_Head_E","ORC_Units_Body_C","ORC_Units_Arms_B","ORC_Units_Legs_B","ORC_Units_Shoulderpads_C","ORC_weapon_Axe_B","ORC_Shield_C"] },
...
const UD: GearPreset[] = [
  ...
  { id: "warrior", label: "Warrior",      description: "Plague Plate & Sword",  color: "#c2410c", animPack: "sword_shield", visibleMeshes: ["UD_Units_head_G","UD_Units_body_D","UD_Units_arms_C","UD_Units_legs_C","UD_Units_shoulderpads_B","UD_weapon_Sword_B","UD_Shield_C"] },
...
const WK: GearPreset[] = [
  ...
  // human_warrior / annihilate-demo — sturdy MMO sword+shield (not greataxe polearm)
