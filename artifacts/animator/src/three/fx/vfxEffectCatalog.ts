...
export const VFX_CATALOG: readonly VfxCatalogEntry[] = [
  ...
  },
  {
    ...
    category: "light",
    color: 0xf0a0c8,
    description: "Freya totem — healing mist anchored a few metres ahead of the caster.",
    tags: ["totem", "heal", "aura", "deploy"],
  },
  {
    id: "totem_attack_ward",
    name: "Totem Attack Ward",
    category: "lightning",
    color: 0x4aa3ff,
    description: "Thor totem — attacking ward pulse around the pole.",
    tags: ["totem", "ward", "aoe", "deploy"],
  },
  {
    id: "totem_trap",
    name: "Totem Trap",
    category: "earth",
    color: 0x6b8f5e,
    description: "Nordin/Loki totem — snare trap at the pole.",
    tags: ["totem", "trap", "slow", "deploy"],
  },
  {
    id: "totem_taunt",
    name: "Totem Taunt",
    category: "arcane",
    color: 0xd4c4a0,
    description: "Odin totem — placed beside the target; taunts nearby hostiles.",
    tags: ["totem", "taunt", "deploy"],
  },
  {
    id: "totem_stun",
    name: "Totem Stun",
    category: "earth",
    color: 0xc9a227,
    description: "Týr / Valhalla totem — stun pulse around the pole.",
    tags: ["totem", "stun", "deploy"],
  },
  {
