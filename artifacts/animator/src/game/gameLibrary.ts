...
export const GAME_LIBRARY: readonly GameEntry[] = [
  ...
  },
  {
    id: "grok-builder",
    title: "Grok Builder",
    short: "Agentic 3D editor",
    blurb:
      "Grok-powered Three.js + Rapier builder — Kenney cursors/SFX (editor·deploy·AI·locks·game flow), Cloudflare asset index, editable UX kit for games. Open + grudge-dev-tool primary builder.",
    category: "voxel",
    tags: ["Grok", "Three.js", "Rapier", "Kenney", "Editor", "AI", "Create"],
    tone: "#f5c542",
  ...
  },
  {
    ...
    short: "Toon RTS + home island",
    blurb:
      "R3F + Rapier RTS / Hero Command with id.grudge-studio.com auth. Forge map editor at forge.grudge-studio.com.",
    category: "warlords",
    tags: ["RTS", "Forge", "Island"],
    tone: "#9d8bff",
