...
export const GAME_LIBRARY: readonly GameEntry[] = [
  ...
  },
  {
    ...
    blurb:
      "Fleet Warlords character → three lanes, buildings, turrets & grudge6 units. Plays inside Open’s in-app canvas (SSO + characterId); product SPA is warlord-genesis.vercel.app.",
    category: "rts",
    tags: ["MOBA", "RTS", "Fleet", "In-app"],
    tone: "#ffd24d",
