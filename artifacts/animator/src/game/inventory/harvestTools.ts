...
export const HARVEST_TOOLS: HarvestToolDef[] = [
  {
    ...
    // ObjectStore / CDN — axe tool; profession Forester icon as fallback branding
  ...
  },
  {
    ...
    icon: "https://assets.grudge-studio.com/game-assets/icons/professions/chef_profession_game_icon.png",
    basePower: 8,
    powerPerLevel: 1.6,
  },
  {
