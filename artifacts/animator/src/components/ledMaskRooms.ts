/**
 * The five "rooms" shown in the gallery under the LED Mask studio. Each room
 * carries two pieces of art: a tall `poster` (the 5-in-a-line card face) and a
 * square `scene` (the 5-in-squares tile + the full-screen loading background
 * shown while entering that room).
 *
 ...
 */
export type RoomTarget = "danger" | "voxel" | "editor" | "lobby";
