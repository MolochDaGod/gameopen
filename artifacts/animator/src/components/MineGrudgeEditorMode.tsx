...
interface Props {
  ...
  /**
   * Prefer live https://mineloader.grudge-studio.com for full networking (default true).
 ...
 * build, and friends/parties, referenced against https://mineloader.grudge-studio.com/
 *
    ...
    <div className="mg-root">
      ...
      <div className="mg-float">
        <div className="mg-brand">
          ...
          <em>{preferLive ? "Live · mineloader.grudge-studio.com" : "Local SPA · /minegrudge"}</em>
