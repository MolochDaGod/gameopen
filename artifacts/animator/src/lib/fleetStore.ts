...
const FLEET_LINKS: readonly StoreItem[] = [
  ...
  },
  {
    id: "studio-portal",
    title: "Grudge Studio",
    blurb: "The ENGINE portal — products index. Account still lives on Open / Railway.",
    category: "account",
    tone: "#66c0f4",
    tags: ["Studio", "Portal"],
  ...
  },
  {
    id: "legion-ai",
    title: "Legion AI",
    blurb: "Chat, image, agents — same Grudge ID token as Open.",
    category: "account",
    tone: "#9d8bff",
    tags: ["AI", "Chat"],
  ...
  },
  {
    id: "fleet-wallet",
    title: "Fleet Wallet",
    blurb: "GBUX + custodial wallet on the same account row.",
    category: "account",
    tone: "#e8c547",
    tags: ["Wallet", "GBUX"],
    href: "https://wallet.grudge-studio.com/",
    priceLabel: "Fleet",
  },
  {
    id: "studio-forge",
    title: "Studio Forge",
    blurb: "Map / .gfscene deploy editor for Warlords.",
    category: "tools",
    tone: "#c9a227",
    tags: ["Forge", "Maps", "Editor"],
  ...
  },
  {
    id: "coder-ide",
    title: "Coder",
    blurb: "Vibe IDE — create with fleet SSO, not a play host.",
    category: "tools",
    tone: "#7ee0a0",
    tags: ["IDE", "Create"],
  ...
  },
  {
    id: "voxel-editor",
    title: "Worldbuilder",
    blurb: "Largest map editor — Play uses Danger Room camera, combat, and loco (no admin).",
    category: "tools",
    tone: "#7ee0a0",
    tags: ["Create", "Maps", "Worldbuilder"],
    poster: "worldbuilder",
    nativeMode: "voxel",
    priceLabel: "In library",
  },
