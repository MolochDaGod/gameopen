...
export function appGuideSystemPrompt(): string {
  return [
    ...
    "- Dressing Room / Animator: dress a character, play the clip library (melee, magic,",
    "  gun, loco walk/run/dodge), Animation Debugger, and AI clip generate (Mixamo quats).",
    "  Locomotion blends idle→walk→run by speed; attacks are one-shots. Hip XYZ root-lock",
    "  keeps walk cycles in place. Use plain words: slash, block, roll, cast, aim, hit.",
