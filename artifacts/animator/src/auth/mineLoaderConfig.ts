/**
 * Mine-Loader / Voxel Realms — production + product pillars.
 *
 * Canonical networked game: https://mineloader.grudge-studio.com/
 * (Cloudflare edge → our Vercel SPA + Railway/WS — never Replit in production)
 * Source monorepo: voxel-realms + staged minegrudge under play shell.
 */

/** Live production host (REST + world WS + full SPA). */
 ...
 * Default: live https://mineloader.grudge-studio.com with SSO + hero handoff.
 */
